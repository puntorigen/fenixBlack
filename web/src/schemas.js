...
export const brandSchema = z.object({
    logo: z.object({
      high_res: z.string().describe('The URL for the high-resolution format of the logo.'),
      vector_format: z.string().describe('The URL for the vector format of the logo.')
    }).describe('High-resolution and vector formats for the logo. Essential for ensuring brand consistency across all platforms.'),
    ...
    email_signature_designs: z.object({
      signature_template_one: z.string().describe('the first email signature template that reflects the brand identity.'),
      signature_template_two: z.string().optional().describe('the second email signature template that reflects the brand identity.')
    }).describe('the templates of email signatures that reflect the brand identity.'),
    ...
    presentation_guidelines: z.string().describe('the guidelines for designing presentations, including slide layouts, the use of logos, color schemes, and typography.'),
    document_guidelines: z.string().describe('the guidelines for formatting official documents, including reports, whitepapers, and proposals, focusing on layout, typography, and use of logos.'),
    landing_page_design_guidelines: z.string().describe('the guidelines of designing landing pages that maintain brand consistency, focusing on typography, color schemes, and imagery style.')
  }); 
